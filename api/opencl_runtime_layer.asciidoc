...
{CL_COMMAND_MIGRATE_MEM_OBJECTS} as the event command type for
{clEnqueueSVMMigrateMem}, but may return an implementation-defined
event command type.
