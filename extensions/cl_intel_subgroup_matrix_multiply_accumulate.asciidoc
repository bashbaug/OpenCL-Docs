...
// i32 = u8 x u8 + i32
8+<| *8-bit integer matrix sources (signed and unsigned), 32-bit integer accumulator*: +
| 32 | 2, 4, 8 | 16 | 32 | `M/2 x int32_t`
| `M/2 x int16_t` with *MatrixAPackedInt8INTEL* and *MatrixASignedComponentsINTEL*
...
| 32 | 2, 4, 8 | 16 | 32 | `M/2 x int32_t`
| `M/2 x int16_t` with *MatrixAPackedInt8INTEL*
| `4 x int32_t` with *MatrixBPackedInt8INTEL* and *MatrixBSignedComponentsINTEL*
| `M/2 x int32_t`
...
// i32 = u4 x u4 + i32
8+<| *4-bit integer matrix sources (signed and unsigned), 32-bit integer accumulator*: +
| 32 | 2, 4, 8 | 16 | 64 | `M/2 x int32_t`
| `M/2 x int16_t` with *MatrixAPackedInt4INTEL* and *MatrixASignedComponentsINTEL*
...
| 32 | 2, 4, 8 | 16 | 64 | `M/2 x int32_t`
| `M/2 x int16_t` with *MatrixAPackedInt4INTEL*
| `4 x int32_t` with *MatrixBPackedInt4INTEL* and *MatrixBSignedComponentsINTEL*
| `M/2 x int32_t`
...
// f32 = f16 x f16 + f32
8+<| *fp16 matrix sources, fp32 accumulator*:
| 32 | 2, 4, 8 | 16 | 16 | `M/2 x float32_t`
| `M/2 x int16_t` with *MatrixAPackedFloat16INTEL*
...
8+<| *bf16 matrix sources, fp32 accumulator*:
| 32 | 2, 4, 8 | 16 | 16 | `M/2 x float32_t`
| `M/2 x int16_t` with *MatrixAPackedBFloat16INTEL*
| `4 x int32_t` with *MatrixBPackedBFloat16INTEL*
| `M/2 x float32_t`

// f16 = f16 x f16 + f16
8+<| *fp16 matrix sources, fp16 accumulator*:
| 32 | 2, 4, 8 | 16 | 16 | `M/2 x float16_t`
| `M/2 x int16_t` with *MatrixAPackedFloat16INTEL*
| `4 x int32_t` with *MatrixBPackedFloat16INTEL*
| `M/2 x float16_t`
...
// bf16 = bf16 x bf16 + bf16
8+<| *bf16 matrix sources, bf16 accumulator*:
| 32 | 2, 4, 8 | 16 | 16 | `M/2 x int16_t` with *MatrixResultBFloat16INTEL*
| `M/2 x int16_t` with *MatrixAPackedBFloat16INTEL*
| `4 x int32_t` with *MatrixBPackedBFloat16INTEL*
