...
The table below describes valid 2D block load and store dimensions for different element sizes for extension version 1.1.0:
...
The table below describes valid 2D block load and store dimensions for different element sizes for extension version 1.2.0:

[cols="1,2*^2,2*^3,^1",width="100%"]
[options="header"]
|=====
| Instruction | Pointer Type | Element Size (Bytes) | Block Width (Elements) | Block Height (Rows) | Block Count

6+| *Block Loads:*

| *OpSubgroup2DBlockLoadINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16, 32, 64 | 1, 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockLoadINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16, 32     | 1, 2, 4, 8, 16, 32 | 2
| *OpSubgroup2DBlockLoadINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16         | 1, 2, 4, 8, 16, 32 | 4

| *OpSubgroup2DBlockLoadINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8, 16, 32 | 1, 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockLoadINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8, 16     | 1, 2, 4, 8, 16, 32 | 2
| *OpSubgroup2DBlockLoadINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8         | 1, 2, 4, 8, 16, 32 | 4

| *OpSubgroup2DBlockLoadINTEL* | `uint32_t`, `void` (untyped) | 4 | 1, 2, 4, 8, 16 | 1, 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockLoadINTEL* | `uint32_t`, `void` (untyped) | 4 | 1, 2, 4, 8     | 1, 2, 4, 8, 16, 32 | 2

| *OpSubgroup2DBlockLoadINTEL* | `uint64_t`, `void` (untyped) | 8 | 1, 2, 4, 8 | 1, 2, 4, 8, 16, 32 | 1

6+| *Block Loads with Transform:*

| *OpSubgroup2DBlockLoadTransformINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16, 32, 64 | 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockLoadTransformINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16, 32     | 4, 8, 16, 32 | 2
| *OpSubgroup2DBlockLoadTransformINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16         | 4, 8, 16, 32 | 4

| *OpSubgroup2DBlockLoadTransformINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8, 16, 32 | 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockLoadTransformINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8, 16     | 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockLoadTransformINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8         | 2, 4, 8, 16, 32 | 1

6+| *Block Loads with Transpose:*

| *OpSubgroup2DBlockLoadTransposeINTEL* | `uint32_t`, `void` (untyped) | 4 | 1, 2, 4, 8 | 1, 2, 4, 8, 16, 32 | 1

| *OpSubgroup2DBlockLoadTransposeINTEL* | `uint64_t`, `void` (untyped) | 4 | 1, 2, 4 | 8 | 1

6+| *Block Stores:*

| *OpSubgroup2DBlockStoreINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16, 32, 64 | 1, 2, 4, 8 | 1

| *OpSubgroup2DBlockStoreINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8, 16, 32 | 1, 2, 4, 8 | 1

| *OpSubgroup2DBlockStoreINTEL* | `uint32_t`, `void` (untyped) | 4 | 1, 2, 4, 8, 16 | 1, 2, 4, 8 | 1

| *OpSubgroup2DBlockStoreINTEL* | `uint64_t`, `void` (untyped) | 8 | 1, 2, 4, 8 | 1, 2, 4, 8 | 1

6+| *Block Prefetch:*

| *OpSubgroup2DBlockPrefetchINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16, 32, 64 | 1, 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockPrefetchINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16, 32     | 1, 2, 4, 8, 16, 32 | 2
| *OpSubgroup2DBlockPrefetchINTEL* | `uint8_t`, `void` (untyped) | 1 | 4, 8, 16         | 1, 2, 4, 8, 16, 32 | 4

| *OpSubgroup2DBlockPrefetchINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8, 16, 32 | 1, 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockPrefetchINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8, 16     | 1, 2, 4, 8, 16, 32 | 2
| *OpSubgroup2DBlockPrefetchINTEL* | `uint16_t`, `void` (untyped) | 2 | 2, 4, 8         | 1, 2, 4, 8, 16, 32 | 4

| *OpSubgroup2DBlockPrefetchINTEL* | `uint32_t`, `void` (untyped) | 4 | 1, 2, 4, 8, 16 | 1, 2, 4, 8, 16, 32 | 1
| *OpSubgroup2DBlockPrefetchINTEL* | `uint32_t`, `void` (untyped) | 4 | 1, 2, 4, 8     | 1, 2, 4, 8, 16, 32 | 2

| *OpSubgroup2DBlockPrefetchINTEL* | `uint64_t`, `void` (untyped) | 8 | 1, 2, 4, 8 | 1, 2, 4, 8, 16, 32 | 1
...
The subgroup size requirements for all instructions were changed in extension version 1.3:

* For extension versions prior to version 1.3, the subgroup size must be 16, as defined by the *SubgroupMaxSize* built-in variable.
Behavior is undefined if these instructions are called from kernels with a different subgroup size.
* For extension versions 1.3 and newer, the subgroup size may be either 16 or 32.
...
|1.1.0|2025-02-28|Ben Ashbaugh|Added SPIR-V support.
|1.2.0|2025-06-30|Ben Ashbaugh|Added SPIR-V support for additional block shapes.
|1.3.0|2025-08-11|Ben Ashbaugh|Added SPIR-V support for a sub-group size of 32.
|========================================
